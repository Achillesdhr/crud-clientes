...
- Pare outros processos usando essas portas

### Erro: "Docker Desktop is not running"
- Inicie o Docker Desktop antes de executar o `docker-compose`
- Aguarde até que o Docker Desktop esteja completamente inicializado
...
- Crie novamente o usuário após reiniciar o backend
...
### Erro: "failed to solve: failed to read dockerfile"
- Certifique-se de estar executando `docker-compose up --build` na pasta raiz do projeto (onde está o docker-compose.yml)
- Verifique se os arquivos Dockerfile existem nas pastas backend e frontend

### Swagger não carrega
- Verifique se o backend está rodando
- Acesse http://localhost:8080/v3/api-docs para verificar se a API está respondendo
